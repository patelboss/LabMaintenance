...
title Lab Maintenance + Audit – CORE STABLE v1.1
...
:: ==================================================
:: [4] PERIPHERAL AUDIT + DATA COLLECTION
:: ==================================================
echo [%date% %time%] STEP: Peripheral Audit >> "%LOGFILE%"
cls
echo [CHECKING] Hardware Health for %PCID%...
...
if not defined KBD_NAME (set "KBD_NAME=MISSING/ERROR")
...
:: Save Header Data to Health File
(
    echo ===================================
    echo   LAB HEALTH REPORT: %PCID%
    echo ===================================
    echo Date: %F_DATE%
    echo Time: %time%
    echo --- HARDWARE ---
...
echo Hardware: KBD: %KBD_NAME% ^| MSE: %MSE_NAME%
echo --------------------------------------------------
...
echo Status: Audit Saved to Health Folder.
echo --------------------------------------------------
...
:COOLDOWN_DONE
echo [%date% %time%] STEP: Finalizing >> "%LOGFILE%"
color 07
set "END_TIME=%time%"
...
shutdown /s /t 120 /c "Maintenance Complete. Hardware: K:%KBD_NAME% M:%MSE_NAME%"
echo.
echo ==================================================
echo   [COMPLETE] ALL CHECKS PASSED.
echo   REPORT: %HEALTHFILE%
echo ==================================================
