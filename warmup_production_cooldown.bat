...
echo [CONFIG] Warmup=%WARMUP_SECONDS% sec Cooldown=%COOLDOWN_SECONDS% sec Shutdown=%SHUTDOWN_WARNING_SECONDS% sec>>"%LOGFILE%"
...
:: COOL-DOWN PHASE (NEW)
:: ==================================================
echo [STEP] Cool-down started (%COOLDOWN_SECONDS% seconds)>>"%LOGFILE%"
